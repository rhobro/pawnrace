...
class PawnRace {
    ...
    // TODO sanitise
    fun playGame(colour: Char, output: PrintWriter, input: BufferedReader) = play(
        colour.uppercase(), // TODO any way to avoid string?
        output,
        input,
    )
    ...
    external fun play(colour: String, output: PrintWriter, input: BufferedReader)
